...
class Ui_ExamQuestions(object):
    def setupUi(self, ExamQuestions):
        ...
        self.TimeLeftProgressBar.setGeometry(QtCore.QRect(430, 864, 501, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.TimeLeftProgressBar.setFont(font)
        self.TimeLeftProgressBar.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.TimeLeftProgressBar.setMaximum(50)
        self.TimeLeftProgressBar.setProperty("value", 46)
        self.TimeLeftProgressBar.setInvertedAppearance(True)
        ...
        self.EndTime.setGeometry(QtCore.QRect(310, 860, 90, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
