...
class Ui_ExamQuestions(object):
    def setupUi(self, ExamQuestions):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../06Icons_and_Logos/ep_program_logo_user_acc_zrP_icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.CompletedProgressBar.setGeometry(QtCore.QRect(390, 860, 541, 23))
        ...
        self.TimeLeft.setGeometry(QtCore.QRect(110, 860, 201, 30))
        ...
        self.Timelabel.setGeometry(QtCore.QRect(10, 860, 93, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.SchoolLabel.setPixmap(QtGui.QPixmap("../06Icons_and_Logos/School logo75x97_grad.png"))
...
"Midterm Exam "))
        ...
        self.Timelabel.setText(_translate("ExamQuestions", "Time Left:"))
